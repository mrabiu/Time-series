...
png(file ="timeSeries_prep.png")
plot(prep, main =" Precipitation time series",
     col.main ="darkgreen")
dev.off()

png(file ="timeSeries_temp.png")
plot(temp, main =" Temperature time series",
     col.main ="darkgreen")
